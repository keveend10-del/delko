...
export const CTASection = () => (
  <section id="cta" className="relative pt-14 pb-20 sm:pt-16 sm:pb-28 overflow-hidden">
    ...
    <div className="container mx-auto px-5 sm:px-8 relative">
      ...
      >
        <div className="eyebrow mb-7">Free Local Visibility Scorecard · No pitch deck</div>
        ...
        <p className="mt-7 text-[17px] sm:text-[18px] text-muted-foreground leading-relaxed max-w-xl mx-auto">
          We check your Google profile, website, reviews, competitors, AI visibility, and follow-up systems — then send a plain-English scorecard within 1–2 business days. Free, no commitment.
        </p>
